...
To export the RMD file containing your homework, you must "Knit" the document, using the knit button above the script, going to *File > Knit document*, or using command + K. This will produce a Word Document of your homework assignment, which you can then upload to be graded. 